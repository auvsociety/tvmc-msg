...
HEAVE_TARGET_OFFSET = 0.05
HEAVE_KP = -40 # -90 #-70 #-60 #-40 #-50 # -100
HEAVE_KI = 0
HEAVE_KD = 30 #30# 5.2 #6.5
HEAVE_TARGET = 0.25 - HEAVE_TARGET_OFFSET
HEAVE_ACCEPTABLE_ERROR = 0.00
...
SURGE_THRUST = 90
ASYNC_CLOCK_DURATION = 4
ASYNC2_CLOCK_DURATION = 3
...
class QualificationTask(StateMachine):
    ...
    surge_forward = initializing_sensors.to(surging_forward)
